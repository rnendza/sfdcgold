({
    initialize: function(component, event, helper) {
        ...
        //--- note the OOTB event to fire setExpId is not firing. probably a sfdc bug or community config issue.
        //--- basically the below will manually call it. it wouldn't shock me if it was a bug. i mean look at the way
        //--- they are spelling helper.
        helper.setExpIdFromUrl(component,event,helper);
    },
