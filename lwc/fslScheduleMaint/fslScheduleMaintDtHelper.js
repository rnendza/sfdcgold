export const dtHelper = {
    getJobsColumns() {
        ...
        let columns = [
            ...
            {
                label: 'Cron Expression', fieldName: 'cronExpression', sortable: true,
                tooltip: {
            ...
            {
                label: 'Cron Last Mod By', fieldName: 'cronLastModBy', sortable: true,
                tooltip: {
                    fieldName: 'cronLastModBy'
                },
                hideDefaultActions: true
            },
            {
                label: 'Cron Created Dt', fieldName: 'cronCreatedDate',type: 'date',
                typeAttributes:{day:'numeric',month:'2-digit',year:'numeric',
                    hour:'2-digit',minute:'2-digit',second:'2-digit',hour12:true},
                initialWidth: 185,
            },
