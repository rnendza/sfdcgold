...
import mainTemplate from './clRouteProcessingProcess.html';
import stencil from './clRouteProcessingProcessStencil.html';
...
export default class ClRouteProcessingProcess extends NavigationMixin(LightningElement) {
    ...
    constructor() {
        super();
        console.info('%c----> /lwc/clRouteProcessingProcess',GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
     ...
     * @param wiredDto
     */
    //etrieveRouteProcessingSheetsForProcessor(Id userId, Date dDate, String type) {
    //@wire(retrieveRouteSchedulesForProcessor, {type:'process',userId: '$_userId', collectionDate: '$_collectionDate'})
    @wire(retrieveRouteSchedulesForProcessor, {type:'process',userId: '$_userId', dDate: '$_collectionDate'})
    ...
    handleItemSelected(evt) {
        ...
        evt.preventDefault();
        evt.stopPropagation();
        this.navigate(PAGE_PROCESS_RPS_SHEETS,rsId)
