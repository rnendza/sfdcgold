...
export default class GeoTabAdminDeviceStatusAssistant extends LightningElement {
    ...
    constructor() {
        super();
        console.info('%c----> /lwc/geoTabAdminDeviceStatusAssistant', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
