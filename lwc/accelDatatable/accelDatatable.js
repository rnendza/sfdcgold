...
export default class AccelDatatable extends LightningElement {
    ...
    tableHeightStyle = this.defaultHeight ? 'height: '+ this.defaultHeight + 'px' : '';
    @api
    get tableHeight() {
