...
export default class AccelAuthSessionAssistant extends LightningElement {
    ...
    constructor() {
        super();
        console.info('%c----> /lwc/accelAuditTrailsAssistant', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
