...
import {exportHelper} from "./accelAuthSessionExporterHelper";
...
export default class AccelAuthSessionExporter extends LightningElement {
    @api
    ...
    constructor() {
        ...
        console.info('%c----> /lwc/accelAuthSessionExporterExport', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
    ...
    downloadToBrowser(csvString) {
        try {
            ...
            let fileName = 'AuthSession_Export_'+ sDate + '.csv';
    ...
    doExportData() {
        ...
        this.log(DEBUG,'---> authSessionExport',csv);
