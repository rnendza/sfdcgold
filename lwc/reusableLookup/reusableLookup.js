...
export default class ReusableLookup extends LightningElement {
    ...
    @api objectLabel = "Asset";
    recordsList = [];
    selectedRecordName;

    @api objectApiName = "Asset";
    ...
    // trying to use so when the warehouse selection is changed, assets are reset and if there is a selected asset when a warehouse changes it is cleared out.
    @api warehouseChanged() {
