...
import {exportHelper} from "./accelAuditTrailsExporterHelper";
...
export default class AccelAuditTrailsExporter extends LightningElement {
    @api
    ...
    constructor() {
        ...
        console.info('%c----> /lwc/accelAuditTrailsExporter', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
    ...
    downloadToBrowser(csvString) {
        try {
            ...
            let fileName = 'Setup_Audit_Trail_Export_'+ sDate + '.csv';
    ...
    doExportData() {
        ...
        this.log(DEBUG,'---> auditTrailsExport',csv);
