...
import retrieveJobInfo from '@salesforce/apex/GeoTabApiController.retrieveScheduledJobInfo';
import fireDeviceStatusJob from '@salesforce/apex/GeoTabApiController.fireDeviceStatusJob';
import abortAllDeviceStatusJobs from '@salesforce/apex/GeoTabApiController.abortAllDeviceStatusJobs';
import {dtHelper} from "./geoTabScheduleMaintDtHelper";
...
const APEX_CLASS_NAMES = ['GeoTab_Sch_QueueableLocRefresh'];


export default class GeoTabScheduleMaint extends LightningElement {
    @api
    ...
    @api showAssistance;
    @api assistanceTitle = 'Device Status Info Job Assistant'
    @api cardTitle = 'Scheduled Jobs';
    @api cardSubtitle = 'Device Status Info Job';
    @api cardIconName = 'standard:shift_scheduling_operation';
    ...
    constructor() {
        ...
        console.info('%c----> /lwc/geoTabScheduleMaint', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }

    connectedCallback() {
        this.retrieveGeoTabScheduledJobs();
    }

    retrieveGeoTabScheduledJobs() {
    ...
    handleAbort(row) {
        ...
        this.confirmDisplayMessage = 'You have indicated that you wish to abort GeoTab Device Status Info scheduled jobId: ' + jobId + '.  Are you sure?';
