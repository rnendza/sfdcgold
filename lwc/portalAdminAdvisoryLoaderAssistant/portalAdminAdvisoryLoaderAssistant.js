...
export default class PortalAdminAdvisoryLoaderAssistant extends LightningElement {
    ...
    constructor() {
        super();
        console.info('%c----> /lwc/portalAdminAdvisoryLoaderAssistant', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
