...
export default class GeoTabAdminSecurityAssistant extends LightningElement {
    ...
    constructor() {
        super();
        console.info('%c----> /lwc/geoTabAdminSecurityAssistant', GLOBAL_CONSTANTS.CONSOLE_MODULE_STYLE);
    }
